...
from smartfridge.utils.patches import imread, imshow, imwrite, torch_save  # for patches
from smartfridge.utils.tqdm import TQDM  # noqa
...
ASSETS_URL = "https://github.com/smartfridge/assets/releases/download/v0.0.0"  # assets GitHub URL
DEFAULT_CFG_PATH = ROOT / "cfg/default.yaml"
NUM_THREADS = min(8, max(1, os.cpu_count() - 1))  # number of YOLO multiprocessing threads
AUTOINSTALL = str(os.getenv("YOLO_AUTOINSTALL", True)).lower() == "true"  # global auto-install mode
VERBOSE = str(os.getenv("YOLO_VERBOSE", True)).lower() == "true"  # global verbose mode
LOGGING_NAME = "smartfridge"
...
try:
    from smartfridge.utils.files import GitRepo
except Exception:
    GitRepo = None
