...
import torch
from smartfridge.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from smartfridge.utils import DEFAULT_CFG_DICT, LOGGER, YAML, colorstr, emojis
from smartfridge.utils.checks import check_requirements, check_suffix, check_yaml
from smartfridge.utils.ops import make_divisible
from smartfridge.utils.patches import torch_load
from smartfridge.utils.plotting import feature_visualization
from smartfridge.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
    ...
    try:
        with temporary_modules(
            modules={
                ...
                "ultralytics.yolo.utils": "smartfridge.utils",
                "ultralytics.yolo.v8": "smartfridge.models.yolo",
                "ultralytics.yolo.data": "smartfridge.data",
            },
            attributes={
                "ultralytics.nn.modules.block.Silence": "torch.nn.Identity",  # YOLOv9e
                "ultralytics.nn.tasks.YOLOv10DetectionModel": "smartfridge.nn.tasks.DetectionModel",  # YOLOv10
                "ultralytics.utils.loss.v10DetectLoss": "smartfridge.utils.loss.E2EDetectLoss",  # YOLOv10
            },
        ):
            if safe_only:
