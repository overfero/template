...
TRACKER_MAP = {"bytetrack": BYTETracker, "botsort": BOTSORT, "ocsort": OCSORT}
...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    if cfg.tracker_type not in {"bytetrack", "botsort", "ocsort"}:
        raise AssertionError(f"Only 'bytetrack', 'botsort' and 'ocsort' are supported for now, but got '{cfg.tracker_type}'")
