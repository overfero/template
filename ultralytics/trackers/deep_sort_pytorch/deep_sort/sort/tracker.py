...
class Tracker:
    ...
    Attributes:
        ...
        kf: kalman_filter.KalmanFilter A Kalman filter to filter target trajectories in image space.
    ...
    def _initiate_track(self, detection):
        ...
        self.tracks.append(
            Track(mean, covariance, self._next_id, self.n_init, self.max_age, detection.oid, detection.feature)
        )
        self._next_id += 1
